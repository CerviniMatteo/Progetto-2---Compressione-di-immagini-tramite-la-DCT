...
public class UtilsConstants {
    ...
    public final static int CHART_HEIGHT = 600;
    public final static String X_AXIS_TITLE = "N (matrix size)";
    public final static String Y_AXIS_TITLE = "Time (s)";
    public final static int MARKER_SIZE = 6;
    public final static String SERIES_MY_DCT = "My DCT";
    public final static String SERIES_LIBRARY_DCT = "Library DCT";
    public final static String WHITESPACE_REGEX = "\\s+";
    public final static String WHITESPACE_REPLACEMENT = "_";
