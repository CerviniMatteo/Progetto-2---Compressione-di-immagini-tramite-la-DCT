...
Per provare la nostra implementazione della compressione tramite DCT2, abbiamo scelto due immagini: una di Tony Pitony, una di Lena (immagine classica per l'image processing) e una scacchiera di $40 \times 40$ pixel.
Per entrambe le immagini, abbiamo applicato la DCT2 con diversi valori di $f$ (la dimensione del blocco) e $d$ (il coefficiente del taglio).
...
Scegliendo il parametro $f$ in modo da far corrispondere i blocchi con i quadrati della scacchiera, ad esempio $f=10$ e $f=5$, e mantenendo solo il coefficiente della componente continua (ovvero $d=1$), otteniamo un'immagine compressa che mantiene la struttura della scacchiera, in quanto essendo i quadrati uniformi, la componente continua è sufficiente per rappresentarli.
