...
Per provare la nostra implementazione della compressione tramite DCT2, abbiamo scelto tre immagini: una di Tony Pitony, una di Lena (immagine classica per l'image processing) e una scacchiera di $40 \times 40$ pixel.
Per tutte le immagini, abbiamo applicato la DCT2 con diversi valori di $f$ (la dimensione del blocco) e $d$ (il coefficiente del taglio).
...
\begin{figure}[H]
	\centering
	% limit graphic size to avoid "Dimension too large" errors
	\includegraphics[width=0.77\textwidth]{figures/ringing.png}
...
\begin{figure}[H]
	\centering
	% limit graphic size to avoid "Dimension too large" errors
	\includegraphics[width=0.75\textwidth]{figures/ringingTonyPitony.png}
...
L'analisi dell'immagine in figura \ref{fig:scacchiera} è interessante in quanto permette di osservare il contributo del coefficiente della componente continua nella trasformata coseno di immagini.
Dato che l'immagine è composta da aree uniformi di colore bianco e nero, la componente a frequenza $0$ (ovvero il coefficiente della componente continua) è particolarmente importante per mantenere la struttura dell'immagine.
Ogni quadrato della scacchiera è di dimensione $10 \times 10$ pixel.
Scegliendo il parametro $f$ in modo da far corrispondere i blocchi con le sezioni uniformi dei quadrati della scacchiera (ad esempio $f=10$ e $f=5$) e mantenendo solo il coefficiente della componente continua (ovvero $d=1$), otteniamo un'immagine compressa che mantiene la struttura della scacchiera. Questo accade in quanto essendo i quadrati uniformi, la componente continua è sufficiente per rappresentarli.
L'effetto della compressione eseguita con questi parametri è mostrato in figura \ref{fig:scacchiera_compressed_f10_d1} e in figura \ref{fig:scacchiera_compressed_f5_d1}.
Scegliendo invece $f=20$, quindi prendendo un blocco che contiene due quadrati neri e due quadrati bianchi, e mantenendo solo il coefficiente della componente continua, otteniamo un'immagine compressa che perde completamente la struttura della scacchiera, risultando in un'immagine grigia uniforme, come mostrato in figura \ref{fig:scacchiera_compressed_f20_d1}.
Aumentando invece il numero di coefficienti mantenuti, ad esempio con $d=10$ o $d=20$, otteniamo un'immagine compressa che recupera parzialmente la struttura della scacchiera, ma con una qualità visiva inferiore rispetto ai casi con $f=10$ o $f=5$, come mostrato in figura \ref{fig:scacchiera_compressed_f20_d10} e in figura \ref{fig:scacchiera_compressed_f20_d20}.
\begin{multicols}{2}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{figures/40x40.png}
	\caption{Scacchiera non compressa}
	\label{fig:scacchiera}
\end{figure}
\columnbreak
\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{figures/40x40_compressed_f10_d1.png}
	\caption{Scacchiera compressa con DCT2, con $f=10$ e $d=1$}
	\label{fig:scacchiera_compressed_f10_d1}
\end{figure}
\end{multicols}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{figures/40x40_compressed_f5_d1.png}
	\caption{Scacchiera compressa con DCT2, con $f=5$ e $d=1$}
	\label{fig:scacchiera_compressed_f5_d1}
\end{figure}
\columnbreak
\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{figures/40x40_compressed_f20_d1.png}
	\caption{Scacchiera compressa con DCT2, con $f=20$ e $d=1$}
	\label{fig:scacchiera_compressed_f20_d1}
\end{figure}
\end{multicols}
\begin{multicols}{2}
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{figures/40x40_compressed_f20_d10.png}
	\caption{Scacchiera compressa con DCT2, con $f=20$ e $d=10$}
	\label{fig:scacchiera_compressed_f20_d10}
\end{figure}
\columnbreak
\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{figures/40x40_compressed_f20_d20.png}
	\caption{Scacchiera compressa con DCT2, con $f=20$ e $d=20$}
	\label{fig:scacchiera_compressed_f20_d20}
\end{figure}
\end{multicols}